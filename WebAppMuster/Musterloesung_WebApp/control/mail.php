<?php
$betreiberSite 	=  "haraldmueller.square7.ch";
...
//      ."<br><br>Betreff:<br>".$betreff
        ...
        $isSent = @mail($empfaenger, "Nachricht von: ".$betreiberSite." :".$betreff." ", "<p>Folgende Nachricht kommt von einem nicht eingeloggten Benutzer der Website ".$betreiberSite.":<br><br>".$mailtext."</p>", "From: $sender\n" . "Content-Type: text/html; charset=utf-8\n");
        
        //Mail an Benutzer/Besucher der Website
        if ($isSent) {
            $isSent = mail($sender, "Danke von ".$betreiberSite, "<p>".$nachrichtErhalten."<br><br>Folgende Angaben hast Du mir gemacht: <br>".$mailtext."</p>", "From: ".$empfaenger."\n" . "Content-Type: text/html; charset=utf-8\n");
        }
        if ($isSent) {
